...
public class TicTacToeClient extends JFrame implements Runnable {
    ...
    public TicTacToeClient(String host) {
        ...
        JPanel boardPanel = new JPanel(); // set up panel for squares in board
    ...
    private void processMessage(String message) {
        ...
        switch (message) {
            ...
            case "New Board" -> {
                String newBoard = input.nextLine();
                String[] tabuleiro = newBoard.split("");
                for (int i = 0; i < 9; i++) {
                    setMark(board[i / 3][i % 3], tabuleiro[i]); // set mark in square;
                }
            }
            ...
            case "Opponent moved" -> {
                ...
                int winner = input.nextInt(); // get winner
